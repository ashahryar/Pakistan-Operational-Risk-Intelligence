...
URL = "https://www.ndma.gov.pk/sitreps?cat_id=3"
...
print(f"Found {len(cards)} SITREP reports")

save_folder = "data/raw/ndma/sitrep"
...
print("\n=================================")
print("✅ SITREP Metadata Saved")
print(f"📁 {json_path}")
print(f"📄 PDFs Downloaded : {len(records)}")
print("=================================")